...
- Gate V1 is **half satisfied**: public-format conformance passes, but DeepSeek-specific nibble order, scale direction/application, and official projection parity remain unverified;
...
- [`INVENTORY-0731.md`](INVENTORY-0731.md) — exact checkpoint inventory status and Gate V0 procedure.
- [`REFERENCE_ACCESS.md`](REFERENCE_ACCESS.md) — smallest official-reference acquisition sequence; answers conventions before full-weight download.
- [`DEEPSEEK_V4.md`](DEEPSEEK_V4.md) — compact DeepSeek-specific architecture/porting reference and assumptions Gate V0 must verify.
...
- [`NUMERICS.md`](NUMERICS.md) — scalar E2M1/UE8M0/E4M3FN arithmetic contract, exactness rules, unresolved DeepSeek conventions, and V1→V2 handoff.
...
- [`VALIDATION.md`](VALIDATION.md) — numerical correctness ladder and merge gates. Its gate concordance maps project `V`-levels to the README and roadmap names.
